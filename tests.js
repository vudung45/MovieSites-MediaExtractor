...
(async function() {
	let vuviphimmoi_test = new VuViPhimmoiMediaExtractor("dau-la-dai-luc", 248754);
	await vuviphimmoi_test.extractMedias().then(r => {
		console.log(`[TEST 5] get media srcs for: https://vuviphimmoi.com/xem-phim-dau-la-dai-luc-248754`);
		console.log(r);
	}).catch(e => console.log(e));
})();